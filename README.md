...
2. **Access the Raw Source:**
   Click the **"Raw"** button located at the top-right corner of the code presentation frame. This loads the clean, unformatted script text directly into the viewport.

3. **Initialize the Tampermonkey Workspace:**
